    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@reduxjs/toolkit': { singleton: true, requiredVersion: deps['@reduxjs/toolkit'], eager: false },
          '@tanstack/react-query': { singleton: true, requiredVersion: deps['@tanstack/react-query'], eager: false }
        }
      }),
